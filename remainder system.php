...
<div id="d1"><button class="btn" onclick="location.href='index.php'"><i class="fa fa-home"></i></button> / Remainder System</div>
	<h1>Remainder System</h1><hr id="hr1">
</nav>




<!--<button class="btn1"><i class="fa fa-pencil"></i></button>
<button class="btn1"><i class="fa fa-close"></i></button>
<button class="btn1"><i class="fa fa-files-o"></i></button>-->
<form method="post" action="">
<input type="text" id="myInput" placeholder=" Quick search">
<button class="btn2" title="Add record"><i class="fa fa-plus"><a href="add remainder.php" style="color:white;font-family:Trebuchet MS;"> Add</a></i></button>
...
<div class="form-popup" id="myForm" >
  <form action="edit remainder.php" class="form-container">

    <label for="id" style="font-family:Trebuchet MS;"><b>Edit record</b></label><br><br>
    <input type="text" placeholder="Enter the rid of the record you want to edit" name="id" required><br>
  ...
  <form action="" class="form-container" method="POST">
    ...
    <input type="text" placeholder="Enter the rid of the record you want to delete" name="idx" required><br>
...
$result = mysqli_query($con,"SELECT * FROM remainder_system where username='$uname' order by $order $sort");
if (!$result) {
...
<tr>
<th><a href='?order=rid&&sort=$sort'>Rid</a></th>
<th><a href='?order=start_date&&sort=$sort'>Date</a></th>
<th><a href='?order=start_time&&sort=$sort'>Time</a></th>
<th><a href='?order=message&&sort=$sort'>Message</a></th>
...
echo "Failed to connect to MySQL: " . mysqli_connect_error();
 ...
 if (isset($_POST['idx'])) {
      $idx = $_POST['idx']; 
$result2 = mysqli_query($con,"DELETE FROM remainder_system WHERE rid='$idx'");	  
