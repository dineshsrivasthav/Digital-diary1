...
<div class="d1"><button class="btn" onclick="location.href='index.php'"><i class="fa fa-home"></i></button> / <b style="color:#8f1503">Address book</b> / Edit</div>
...
$uname=$_SESSION['userid'];
		$result = mysqli_query($con,"SELECT * FROM address_book WHERE username='$uname' and aid=$id ");
if (!$result) {
...
$other_details1=filter_input(INPUT_POST, 'other_details');
	$result1=mysqli_query($con,"UPDATE address_book SET name='$name1',gender='$gender1',dob='$dob1',father_name='$father_name1',mobile='$mobile1',email='$email1',address='$address1',qualification='$qualification1',designation='$designation1',nationality='$nationality1',other_details='$other_details1' where aid=$id ");
